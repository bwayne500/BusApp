//
//  DepartureStopTableViewController.swift
//  Bus
//
...
import CryptoKit
import Foundation
class DepartureStopTableViewController: UITableViewController {
    var BusNumber = "300"
    ...
    @objc func jsonParsingFromURL () {
        ...
        """
        let request = NSMutableURLRequest(url: NSURL(string: "https://ptx.transportdata.tw/MOTC/v2/Bus/EstimatedTimeOfArrival/City/Taichung?$filter=RouteName%2FZh_tw%20eq%20%27"+BusNumber+"%27%20and%20Direction%20eq%20%270%27&$orderby=StopSequence%20asc&$top=100&$format=JSON")! as URL)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "DepartureStopCell", for: indexPath) as! DepartureStopTableViewCell
        var value = Int()
        ...
        cell.DepartureStopName.text = BusStop[indexPath.row] as! String
